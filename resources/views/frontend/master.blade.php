			...
			<div class="row">
				<div id="sidebar" class="col-md-3">
					...
					<div id="banner-l" class="text-center">
						...
						<div class="banner-l-item">
							<a href="{{asset('/')}}"><img src="img/home/banner7.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
					...
					<div id="banner-t" class="text-center">
						<div class="row">
							<div class="banner-t-item col-md-6 col-sm-12 col-xs-12">
								<a href="{{asset('/layout/frontend/')}}"><img src="img/home/banner-t-1.jpg" alt="" class="img-thumbnail"></a>
							</div>
							<div class="banner-t-item col-md-6 col-sm-12 col-xs-12">
								<a href="{{asset('/layout/frontend/')}}"><img src="img/home/banner-t-1.jpg" alt="" class="img-thumbnail"></a>
							</div>
			...
			<div class="container">
				<div class="row">				
					...
					<div id="about" class="col-md-3 col-sm-12 col-xs-12">
						<h3>About us</h3>
						<p class="text-justify">Shop- Lê H Quân</p>
					</div>
					<div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
						<h3>Hotline</h3>
						<p>Phone Sale: (+84) 034586507</p>
						<p>Email: leqhnt@gmail.com</p>
					</div>
					<div id="contact" class="col-md-3 col-sm-12 col-xs-12">
						<h3>Contact Us</h3>
						<p>Address : Hoang Mai - Hà Nội</p>
				...
				<div class="container">
					<div class="row">
						...
						<div id="footer-b-r" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>© 2017 Lê H Quân. All Rights Reserved</p>
						</div>
					</div>
				</div>
				<div id="scroll">
