	...
	<div id="list-cart">
		...
		<form>
			<table class="table table-bordered .table-responsive text-center">
				...
				<tr>
					<td><img height="150px" class="img-responsive" src="{{asset('storage/' . $item->options->img)}}"></td>
					<td>{{$item->name}}</td>
					<td>
		...
		@else
			<h4 style="text-align: center; margin-top: 40px;">Gio hang khong co gi!! Xin moi tiep tuc mua :)</h3>
		@endif
	</div>            	                	
	</div>
</div>
